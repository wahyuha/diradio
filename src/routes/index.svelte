...
<article class="screen">
  ...
  <label class="main" for="magicButton" />
  ...
  <table class="list">
    <tr class="song">
      ...
      <td><input type="checkbox" id="heart" /><label class="zmr" for="heart"/></td>
    </tr>
    ...
    <tr class="song">
      ...
      <td><input type="checkbox" id="heart1" checked /><label class="zmr" for="heart1"/></td>
    </tr>
    ...
    <tr class="song">
      ...
      <td><input type="checkbox" id="heart2" /><label class="zmr" for="heart2"/></td>
    </tr>
    ...
    <tr class="song">
      ...
      <td><input type="checkbox" id="heart3" checked /><label class="zmr" for="heart3"/></td>
    </tr>
    ...
    <tr class="song">
      ...
      <td><input type="checkbox" id="heart4" /><label class="zmr" for="heart4"/></td>
    </tr>
    ...
    <tr class="song">
      ...
      <td><input type="checkbox" id="heart5" /><label class="zmr" for="heart5"/></td>
    </tr>
    ...
    <tr class="song">
      ...
      <td><input type="checkbox" id="heart6" /><label class="zmr" for="heart6"/></td>
    </tr>
    ...
    <tr class="song">
      ...
      <td><input type="checkbox" id="heart7" /><label class="zmr" for="heart7"/></td>
    </tr>
    ...
    <tr class="song">
      ...
      <td><input type="checkbox" id="heart8" /><label class="zmr" for="heart8"/></td>
    </tr>
  </table>
  ...
  <div class="info">
    <h4>Indika FM</h4>
    <h3>Lebih baik bersama 91.60 Indika FM!</h3>
  </div>
  <audio preload="auto" id="audio" controls>
    <source src="https://s2.radio.co/sf58a82d7d/listen" />
  </audio>
  <table class="player">
    <td><input type="checkbox" id="backward" /><label class="backward"for="backward"/></td>
    <td>
      <input type="checkbox"id="play"title="Play" on:click={togglePlayPause} />
      <label class="play" for="play" />
    </td>
    <td><input type="checkbox" id="forward" /><label class="forward"for="forward"/></td>
  </table>

  <table class="footer">
    <td><input type="checkbox" id="love" checked /><label class="love"for="love"/></td>
    <td><input type="checkbox" id="shuffle" /><label class="shuffle"for="shuffle"/></td>
    <td><input type="checkbox" id="repeat" checked /><label class="repeat"for="repeat"/></td>
    <td><input type="checkbox" id="options" /><label class="options"for="options"/></td>
  </table>
...
<style type="text/scss">
  ...
  .coverImage {
    background: url("/images/muse.jpeg") no-repeat;
